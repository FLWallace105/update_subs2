...
module FixSubInfo
  class SubUpdater
    ...
    def load_update_products
      ...
      CSV.foreach('jan2019_update_products.csv', :encoding => 'ISO-8859-1', :headers => true) do |row|
        # puts row.inspect
        sku = row['sku']
    ...
    def load_current_products
      ...
      @conn.prepare('statement1', "#{my_insert}")
      CSV.foreach('jan2019_current_products.csv', :encoding => 'ISO-8859-1', :headers => true) do |row|
        # puts row.inspect
