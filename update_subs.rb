  ...
  class SubUpdater
    ...
    def setup_employee_ghost
      ...
      CSV.foreach('employee_customer_ids.csv', :encoding => 'ISO-8859-1', :headers => true) do |row|
        ...
        puts customer_id
        my_subs = Subscription.where("status = ? and customer_id = ? and next_charge_scheduled_at > \'2020-10-31\' ", "ACTIVE", customer_id)
    ...
    def setup_subscription_update_table
     ...
     june2020_nulls = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where status = 'ACTIVE' and    next_charge_scheduled_at is null "

     june2020_ghost_remainder = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where status = 'ACTIVE' and next_charge_scheduled_at > '2020-05-31'  and  next_charge_scheduled_at < '2020-07-01'  and product_title not ilike \'3%month%\' and  product_title  ilike \'paradise%cove%\' "

      #employees_to_ghost_july = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where status = 'ACTIVE' and next_charge_scheduled_at > '2020-06-30'  and  next_charge_scheduled_at < '2020-08-01'  and ( customer_id = '1956853' or customer_id = '32830168' or customer_id = '3492146' or customer_id = '3498906' or customer_id = '9928089' or customer_id = '10689233' or customer_id = '18310557' or customer_id = '20676282' or customer_id = '26931284' or customer_id = '29164051' or customer_id = '30143418' or customer_id = '31049597' or customer_id = '3498990' or customer_id = '32330390' or customer_id = '35113621' or customer_id = '26630650' or customer_id = '26016178') "

      prepaid_subs_charging_early_july = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where status = 'ACTIVE' and next_charge_scheduled_at > '2020-06-30'  and  next_charge_scheduled_at < '2020-08-01'  and product_title not ilike '3%month%'
       and subscriptions.product_title not ilike 'berry%crush%' and subscriptions.product_title not ilike 'summer%sunset%' and subscriptions.product_title not ilike 'renewal%' and subscriptions.product_title not ilike 'twilight%' and subscriptions.product_title not ilike 'wild%instinct%' and subscriptions.product_title not ilike 'serve%up%' and subscriptions.product_title not ilike 'hibiscus%' and subscriptions.product_title not ilike 'bright%idea%' and subscriptions.product_title not ilike 'ooh%la%' and subscriptions.product_title not ilike 'peach%sorbet%' and subscriptions.product_title not ilike 'pinky%swear%' and subscriptions.product_title not ilike 'hillside%hike%' and subscriptions.product_title not ilike 'one%mile%' and subscriptions.product_title not ilike 'bootcamp%beauty%' and subscriptions.product_title not ilike 'moonlight%rose%'  and subscriptions.product_title not ilike 'laguna%getaway%'  "

      my_delete = "delete from subscriptions_updated where product_title ilike 'Ellie%Packable%Backpack%' "

      cleanup_subs = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where ( shopify_product_id = '4408141545530' or shopify_product_id = '4408141643834' or shopify_product_id = '4408142102586' or shopify_product_id = '4466295406650' or shopify_product_id = '4466296094778' or product_title ilike 'coastal%cool%' or product_title ilike 'cupids%kiss%' or product_title ilike 'dream%on%' or product_title ilike 'emerald%tide%' or product_title ilike 'fresh%tone%' or product_title ilike 'golden%girl%'  or product_title ilike 'mineral%love%' or product_title ilike 'natural%fit%'  or product_title like 'off%grid%' or product_title ilike 'roll%dye%' or product_title ilike 'wind%breaker%' ) and status = 'ACTIVE' and ( next_charge_scheduled_at is null or next_charge_scheduled_at < '2020-08-01' ) "

      prepaid_charging_aug1_6 = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where product_title ilike \'3%month%\' and next_charge_scheduled_at > \'2020-07-31\' and next_charge_scheduled_at < \'2020-08-07\' "

      null_subs_all = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where next_charge_scheduled_at is null "

      aug2020_ghost_remainder = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where status = 'ACTIVE' and next_charge_scheduled_at > '2020-07-31'  and  next_charge_scheduled_at < '2020-09-01'  and product_title not ilike \'3%month%\' and  product_title not ilike 'second%skin%' and product_title not ilike 'city%limit%' and product_title not ilike 'gear%up%' and product_title not ilike 'nightfall%' and product_title not ilike 'olive%grove%' and product_title not ilike 'a%new%gray%' and product_title not ilike 'sweet%spot%' and product_title not ilike 'feel%beet%' and product_title not ilike 'trail%blazer%' and product_title not ilike 'blush%dreams%' and product_title not ilike 'silver%lining%' and product_title not ilike 'color%pop%' and product_title not ilike 'ellie%pick%' "

      gcastro = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where status = 'ACTIVE' and subscription_id = '21255093' "

      sept2020_prepaid_charging = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where status = 'ACTIVE' and next_charge_scheduled_at > '2020-08-31'  and  next_charge_scheduled_at < '2020-09-07'  and product_title  ilike \'3%month%\' "

      all_nulls = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where status = 'ACTIVE' and next_charge_scheduled_at is null  "
      ...
      jan2021_bill_non_early_prepaid = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions, sub_collection_sizes where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at > '2021-01-05' and subscriptions.next_charge_scheduled_at < '2021-02-01' and sub_collection_sizes.subscription_id = subscriptions.subscription_id and subscriptions.is_prepaid = \'t\' "

      jan2021_bill_later_non_prepaid = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions, sub_collection_sizes where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at > '2021-01-05' and subscriptions.next_charge_scheduled_at < '2021-02-01' and sub_collection_sizes.subscription_id = subscriptions.subscription_id and subscriptions.is_prepaid = \'f\' and (  sub_collection_sizes.product_collection not ilike 'ellie%pick%')"

      jan2021_nulls_prepaid = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions, sub_collection_sizes where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at is null and sub_collection_sizes.subscription_id = subscriptions.subscription_id and subscriptions.is_prepaid = \'t\' "

      oct2020_rest_monthly = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions, sub_collection_sizes where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at > '2020-10-05' and subscriptions.next_charge_scheduled_at < '2020-11-01' and sub_collection_sizes.subscription_id = subscriptions.subscription_id and subscriptions.product_title  not ilike \'3%month%\' and  ( sub_collection_sizes.product_collection not ilike 'wild%instinct%' and  sub_collection_sizes.product_collection not ilike 'nightfall%' and sub_collection_sizes.product_collection not ilike 'positively%pink%' and sub_collection_sizes.product_collection not ilike 'namaste%in%' and sub_collection_sizes.product_collection not ilike 'guiding%light%' and sub_collection_sizes.product_collection not ilike 'full%bloom%' and sub_collection_sizes.product_collection not ilike 'what%gem%' and sub_collection_sizes.product_collection not ilike 'ellie%pick%')"
      ...
      oct2020_ghost = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions, sub_collection_sizes where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at > '2020-10-31' and subscriptions.next_charge_scheduled_at < '2020-12-01' and sub_collection_sizes.subscription_id = subscriptions.subscription_id and subscriptions.product_title  not ilike \'3%month%\' and  ( sub_collection_sizes.product_collection not ilike 'balanced%beige%' and  sub_collection_sizes.product_collection not ilike 'purple%haze%' and sub_collection_sizes.product_collection not ilike 'glamazon%' and sub_collection_sizes.product_collection not ilike 'gold%rush%' and sub_collection_sizes.product_collection not ilike 'wine%down%' and sub_collection_sizes.product_collection not ilike 'ellie%pick%') and subscriptions.is_prepaid = \'f\' "

      dec2020_prepaid = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions, sub_collection_sizes where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at > '2020-11-30' and subscriptions.next_charge_scheduled_at < '2020-12-08' and sub_collection_sizes.subscription_id = subscriptions.subscription_id and   ( sub_collection_sizes.product_collection not ilike 'polar%perfection%' and  sub_collection_sizes.product_collection not ilike 'winter%bloom%' and  sub_collection_sizes.product_collection not ilike 'midnight%sky%' and  sub_collection_sizes.product_collection not ilike 'elemental%' and  sub_collection_sizes.product_collection not ilike 'posies%paris%' and  sub_collection_sizes.product_collection not ilike 'malibu%moment%' and  sub_collection_sizes.product_collection not ilike 'mauve%noir%' and   sub_collection_sizes.product_collection not ilike 'ellie%picks%') and subscriptions.is_prepaid = \'t\' "

      dec2020_monthly = "insert into subscriptions_updated (subscription_id, customer_id, updated_at, created_at,  next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions, sub_collection_sizes where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at > '2020-11-30' and subscriptions.next_charge_scheduled_at < '2021-01-01' and sub_collection_sizes.subscription_id = subscriptions.subscription_id and   ( sub_collection_sizes.product_collection not ilike 'polar%perfection%' and  sub_collection_sizes.product_collection not ilike 'winter%bloom%' and  sub_collection_sizes.product_collection not ilike 'midnight%sky%' and  sub_collection_sizes.product_collection not ilike 'elemental%' and  sub_collection_sizes.product_collection not ilike 'posies%paris%' and  sub_collection_sizes.product_collection not ilike 'malibu%moment%' and  sub_collection_sizes.product_collection not ilike 'mauve%noir%' and   sub_collection_sizes.product_collection not ilike 'ellie%picks%') and subscriptions.is_prepaid = \'f\' "
     ...
     #Now reset index
     ActiveRecord::Base.connection.reset_pk_sequence!('subscriptions_updated')
     ActiveRecord::Base.connection.execute(jan2021_bill_later_non_prepaid)
     ...
     puts "All done with Dec 2020 Monthly set up"
...
#·       250 Medium tops from Berry Crush to Good Karma
    ...
    def load_current_products
      ...
      ActiveRecord::Base.connection.execute(my_config_sql).each do |row|
        ...
        when "3 MONTHS"
          next_month_prod_id = "4620659851322"
        else
          next_month_prod_id = "4620659851322"
        end
